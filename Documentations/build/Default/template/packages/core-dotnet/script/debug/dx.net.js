    ...
    (function (Content) {
        ...
        (function (Features) {
            ...
            var HighlightTextDocumentFeature = (function (_super) {
                    ...
                    if (message != null) {
                        switch (message.messageType) {
                            case Content.DocumentMessageNames.quickSearch:
                                this.highlightText(message.messageData, true);
                                break;
                ...
                HighlightTextDocumentFeature.prototype.highlightText = function (text, clearBefore) {
                    ...
                    if (text != "") {
                        ...
                        if (this._firstMatch != null && clearBefore) {
                ...
                HighlightTextDocumentFeature.prototype.highlightTextInElement = function (element, text) {
                    ...
                    for (var x = element.childNodes.length - 1; x >= 0; x--) {
                        ...
                        if (node.nodeType == 3) {
                            ...
                            for (var pos = lowerCaseNodeText.indexOf(lowerCaseText); pos >= 0; pos = lowerCaseNodeText.indexOf(lowerCaseText)) {
